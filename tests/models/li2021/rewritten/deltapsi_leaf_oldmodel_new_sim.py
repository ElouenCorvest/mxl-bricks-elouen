...
def do_complete_sim(y, constants_set_and_trace_times, Kx):
    ...
    time_axis = np.append(np.linspace(0, 1200, 1000), np.linspace(1200, 1200 + 5 * 60, 1000))
    # print(time_axis)
    ...
    output["pH_lumen"] = output["pHlumen"]
