...
def f(y, t, pKreg, max_PSII, kQA, max_b6f, lumen_protons_per_turnover, PAR, ATP_synthase_max_turnover, 
    ...
    """
     #two protons per electron transferred from PQH2 to PC
...
def sim_a_gtype(gtype_dict, gtype='WT', light = 100):  
    ...
    print(light_pattern['single_square_20_min_500_max'][1])
    plt.plot(light_pattern['single_square_20_min_500_max'][0], light_pattern['single_square_20_min_500_max'][1])
    plt.show()
    if light ==100:
