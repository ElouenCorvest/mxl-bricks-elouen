...
def pi_ext(compartment: str = "", tissue: str = "") -> str:
...
def e_total(compartment: str = "", tissue: str = "") -> str:
...
def total_pq(compartment: str = "", tissue: str = "") -> str:
    return loc("PQ_tot", compartment, tissue)


def total_pc(compartment: str = "", tissue: str = "") -> str:
    return loc("PC_tot", compartment, tissue)


def total_ascorbate(compartment: str = "", tissue: str = "") -> str:
    return loc("ASC_tot*", compartment, tissue)


def total_ferredoxin(compartment: str = "", tissue: str = "") -> str:
    return loc("Fd*", compartment, tissue)


def total_glutamate(compartment: str = "", tissue: str = "") -> str:
    return loc("Glu+Oxo", compartment, tissue)


def total_glutathion(compartment: str = "", tissue: str = "") -> str:
    return loc("Glutathion_tot", compartment, tissue)


def total_lhc(compartment: str = "", tissue: str = "") -> str:
    return loc("LHC_tot", compartment, tissue)


def total_orthophosphate(compartment: str = "", tissue: str = "") -> str:
    return loc("Pi_tot", compartment, tissue)


def total_carotenoids(compartment: str = "", tissue: str = "") -> str:
    return loc("Carotenoids_tot", compartment, tissue)


def total_thioredoxin(compartment: str = "", tissue: str = "") -> str:
    return loc("Thioredoxin_tot", compartment, tissue)


def total_psbs(compartment: str = "", tissue: str = "") -> str:
...
def glycolaldehyde_dehydrogenase(compartment: str = "", tissue: str = "") -> str:
...
def transaldolase_f6p_gad_gap_xyl(compartment: str = "", tissue: str = "") -> str:
    return loc("transaldolase_f6p_gad_gap_xyl", compartment, tissue)


def transketolase_gad_s7p_r5p_eru(compartment: str = "", tissue: str = "") -> str:
    return loc("transketolase_gad_s7p_r5p_eru", compartment, tissue)


def transketolase_f6p_gad_gap_xylulose(compartment: str = "", tissue: str = "") -> str:
...
def acetyl_coa_carboxyltransfer(compartment: str = "", tissue: str = "") -> str:
...
def ferredoxin_thioredoxin_reductase(compartment: str = "", tissue: str = "") -> str:
    return loc("ferredoxin_thioredoxin_reductase", compartment, tissue)


def nadph_thioredoxin_reductase(compartment: str = "", tissue: str = "") -> str:
...
def glycine_hydroxymethyltransferase(compartment: str = "", tissue: str = "") -> str:
...
def methylene_thf_dehydrogenase(compartment: str = "", tissue: str = "") -> str:
...
def phosphoglycolate_phosphatase(compartment: str = "", tissue: str = "") -> str:
...
def pyruvate_phosphate_dikinase(compartment: str = "", tissue: str = "") -> str:
    return loc("pyruvate_phosphate_dikinase", compartment, tissue)


def ribulose_phosphate_epimerase(compartment: str = "", tissue: str = "") -> str:
...
def serine_glyoxylate_transaminase(compartment: str = "", tissue: str = "") -> str:
...
def tartronate_semialdehyde_reductase(compartment: str = "", tissue: str = "") -> str:
...
def light_speedup(compartment: str = "", tissue: str = "") -> str:
    return loc("light_speedup", compartment, tissue)


def tr_activation(compartment: str = "", tissue: str = "") -> str:
    return loc("tr_activation", compartment, tissue)


def tr_inactivation(compartment: str = "", tissue: str = "") -> str:
